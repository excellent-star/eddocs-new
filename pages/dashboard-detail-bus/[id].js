...
const LISTE_ONE_BUS=gql`
    query LISTE_ONE_BUS($id:ID!) { 
      bus(id:$id)
      {
        id
        numero
...
export default function DashboardDetailBus ({query}) {

    const {data,error,loading}=useQuery(LISTE_ONE_BUS,{
        variables:{
            id:query.id
        }
    });
    ...
    const bus=data?.bus
    const details=data?.bus.recolteurs
  return (
    <>
      <PageWrapper
        headerConfig={{
                        ...
                        <div className="job-details-content pt-8 pl-sm-9 pl-6 pr-sm-9 pr-6 pb-10 border-bottom border-width-1 border-default-color light-mode-texts">
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <>Liste des recolteur du bus N°  {bus.numero} </>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="row">
                                ...
                                <table className="table table-striped table-hover">
                                    <thead style={{borderBottom:".5px solid #ccc"}}>
                                        ...
                                        {
                                            data!=="undefined" ?(
                                            details.map((recolteur,index)=>(
                                                
                                                <tr className="border border-color-2" key={"LigneTableBusRecolteurDetail"+index}>
